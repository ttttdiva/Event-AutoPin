...
export default React.memo(CircleRowInner, (prev, next) => {
  return (
    prev.circle.id === next.circle.id &&
    prev.circle.purchaseStatus === next.circle.purchaseStatus &&
    prev.circle.memo === next.circle.memo &&
    prev.circle.priorityColor === next.circle.priorityColor &&
    prev.circle.circleCutFilename === next.circle.circleCutFilename &&
